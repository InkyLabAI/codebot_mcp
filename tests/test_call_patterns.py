...
from codebot_mcp.code_parsing.data_classes import FunctionChunk, ClassChunk
...
'''
        ...
        use_func = next(f for f in resolved if f.name == 'use_nested')
...
'''
        ...
        outer_init = next(f for f in resolved if f.name == '__init__' and f.class_name == 'Outer')
...
'''
        ...
        func = next(f for f in resolved if f.name == 'with_default')
...
'''
        ...
        func = next(f for f in resolved if f.name == 'use_bound')
...
'''
        ...
        func = next(f for f in resolved if f.name == 'apply')
...
'''
        ...
        func = next(f for f in resolved if f.name == 'use_lambda')
...
'''
        ...
        func = next(f for f in resolved if f.name == 'process_first')
...
'''
        ...
        use_func = next(f for f in resolved if f.name == 'use_property')
...
'''
        ...
        func = next(f for f in resolved if f.name == 'create_point')
...
'''
        ...
        run_method = next(f for f in resolved if f.name == 'run')
